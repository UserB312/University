 ...
 *  CIVIL  ( C -> Casado, S -> Soltero, U -> Uni?n Libre ) de un grupo de   *
 *  personas. Se desea conocer el N?mero de personas por SEXO y por ESTADO  *
 *  CIVIL.  (PROBLEMA No 13 DEL TALLER No 1)                                *
 *                                                                          *
 ****************************************************************************/
